var vueinst = new Vue({
    ...
    data: {
        ...
        editing: { username: false, address_id:false, password:false, add_addr:false},
        form:    { user_id:'', username: '', address_id:'' , address:'', city:'', state:'', postcode:'', password:''},
    ...
    methods: {
        ...
        email_change(){
            ...
            xhttp.setRequestHeader("Content-type", "application/json");
            xhttp.send(JSON.stringify({ address_id, address, city, state, postcode }));
        },
        add_address(){
            var ptr = this;
        ...
        password_change(){
            var ptr = this;
            if(!ptr.reset_pass.password || !ptr.reset_pass.confirm_password || !ptr.reset_pass.email_code){
        ...
        isBlocked: function (status) {
            ...
            else if(this.user_covid_status === 'Red' || this.user_covid_status === 'Yellow'){
                return true;
            }
            return false;
        },
